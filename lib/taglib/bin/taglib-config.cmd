...
:doit
if /i "%1#" == "--libs#"    echo -LE:/mylib/taglib/build/lib -llibtag
if /i "%1#" == "--cflags#"  echo -IE:/mylib/taglib/build/include -IE:/mylib/taglib/build/include/taglib
if /i "%1#" == "--version#" echo 2.0.2
if /i "%1#" == "--prefix#"  echo E:/mylib/taglib/build
